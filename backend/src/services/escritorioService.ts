...
export class EscritorioService {
  /**
   * Lista todos os escritórios ativos
   */
  ...
  /**
   * Obtém o aviso global configurado
   */
  public static async getAvisoGlobal(): Promise<string> {
    return ConfigService.get('AVISO_GLOBAL_SISTEMA', '');
  }
}
